...
namespace DoorsExpanded
{
    ...
    public static class HarmonyPatches
    {
            ...
            IEnumerable<CodeInstruction> instructions)
        {
            ...
            {
                if (instruction.operand == methodof_RuntimeHelpers_RunClassConstructor)
        ...
        public static void PatchAll()
        {
            ...
            if (GenTypes.GetTypeInAnyAssemblyNew("OpenedDoorsDontBlockLight.GlowFlooder_Patch", null) is
